<?php
//Định nghĩa 1 hằng số bảo vệ Project.
	define("IN_SITE",true);
	//Lấy module và action trên URL
	$module = isset($_GET['m']) ? $_GET['m'] : '';
	$action = isset($_GET['a']) ? $_GET['a'] : '';
	//Trường hợp người dùng không truyền module và action thì ta lấy module mặc định là common
	...
	//Trường hợp URL không tồn tại thì báo lỗi.
